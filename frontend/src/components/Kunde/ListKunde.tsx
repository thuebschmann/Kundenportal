              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.vorname}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>strasse</p>
                    <p className={'line-clamp-2'}>{item.strasse}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>plz</p>
                    <p className={'line-clamp-2'}>{item.plz}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>ort</p>
                    <p className={'line-clamp-2'}>{item.ort}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>land</p>
                    <p className={'line-clamp-2'}>{item.land}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>partnernr</p>
                    <p className={'line-clamp-2'}>{item.partnernr}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>firma</p>
                    <p className={'line-clamp-2'}>{item.firma}</p>
                  </div>
